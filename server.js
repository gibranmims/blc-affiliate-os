...
const projectAttachmentsRoutes = require('./routes/project-attachments');
const partnersRoutes       = require('./routes/partners');
const teamMembersRoutes    = require('./routes/team-members');
const subscriptionsRoutes  = require('./routes/subscriptions');
const brandFinanceRoutes   = require('./routes/brand-finance');
const adSpendRoutes        = require('./routes/ad-spend');
...
app.use('/api/project-attachments', projectAttachmentsRoutes);
app.use('/api/partners',          partnersRoutes);
app.use('/api/team-members',      teamMembersRoutes);
app.use('/api/subscriptions',     subscriptionsRoutes);
app.use('/api/brand-finance',     brandFinanceRoutes);
